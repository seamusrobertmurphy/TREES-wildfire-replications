...
-   Global burned area may be underestimated by 20-30% [@giglio2010assessing]
...
IPCC defaults (Table 2.5) based on [@andreae2001emission]:
...
1.  Document all assumptions and parameter choices
2.  Report uncertainty ranges alongside emission estimates
3.  Conduct sensitivity analyses for key parameters
4.  Compare with independent data sources where available
...
Optional Disaggregation Approach [@ipccChapter2Generic2019][^index-2]:
...
[^index-2]: Section 2.6: URL to page number here
